...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/test/testDataCopy/">测试数据生成功能名列表</a></li>
		<shiro:hasPermission name="test:testDataCopy:edit"><li><a href="${ctx}/test/testDataCopy/form">测试数据生成功能名添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="testDataCopy">
			<tr>
				...
				<shiro:hasPermission name="test:testDataCopy:edit"><td>
					...
					<a href="${ctx}/test/testDataCopy/delete?id=${testDataCopy.id}" onclick="return confirmx('确认要删除该测试数据生成功能名吗？', this.href)">删除</a>
